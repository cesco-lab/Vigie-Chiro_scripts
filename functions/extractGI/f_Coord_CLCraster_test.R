...
Coord_CLCraster=function(points,names_coord,bm,bl,layer)
{
  ...
  test2=fread(paste0("C:/Users/yvesb/Downloads/Indicateurs_CLCraster_L93_5points_26-08",".csv"))
  test3=match(paste0(test2$longitude,test2$latitude),paste0(test$longitude,test$latitude))
  ...
  N3=colnames(HabufPropT)[testNC]
  HabufPropT3l=HabufPropT[,..N3]
  apply(HabufPropT3l[90:93,],2,sum)[order(names(apply(HabufPropT3l[90:93,],2,sum)))]
  Prop32=as.data.table(table(substr(colnames(HabufPropT3l),1,6)))
  ...
  apply(OCS[90:93,],2,sum)[order(names(apply(OCS[90:93,],2,sum)))]
