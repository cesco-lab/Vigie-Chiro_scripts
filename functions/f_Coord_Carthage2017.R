...
if(Test)
{
  #for testing
  Coord_Carthage(
    points="mnt/GI/SysGrid_Radius_ 90000_50000" #table giving coordinates in WGS84
    ,
    #names_coord=c("longitude","latitude") #vector of two values giving 
    names_coord=c("Group.1","Group.2") #vector of two values giving 
    #names_coord=c("Lon_WGS84_bary","Lat_WGS84_bary")
    ,
    bs=50
    ,
    bm=500
    ...
    carthagep="mnt/SIG/CARTHAGE/EltHydroSurface_FXX.shp"
    ,
    #  carthagec="C:/wamp64/www/CARTHAGE_COURS/TRONCON_HYDROGRAPHIQUE.shp"
    carthagec="mnt/SIG/CARTHAGE/TronconHydrograElt_FXX.shp"
