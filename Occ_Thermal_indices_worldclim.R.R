...
# if a file with species names is available:
species <- levels(factor(data$species))
# otherwise: 
species <- c("Eptesicus serotinus", "Eptesicus nilssonii", "Nyctalus lasiopterus", "Nyctalus noctula", "Nyctalus leisleri", 
             ...
             "Hypsugo savii", "Myotis alcathoe", "Plecotus macrobullaris", "Plecotus macrobullaris")
...
for(j in c(1,5,6)){  # 1, 5 and 6 for the bioclim variable we use (annual mean T, max T and min T)
