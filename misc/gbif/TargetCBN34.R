...
#ListTargets=fread("C:/Users/yvesb/Documents/VigieChiro/gbifData/DataSelDate/DataSelRare__90.csv")
ListTargets=c("Aristolochia rotunda","Aristolochia pistolochia")
...
#Suffix="FR"
OutputName="C:/Users/yvesb/Documents/www/Raw90FR"
...
DataFj=subset(DataF,DataF$name %in% ListTargets)
