...
ListRef=shapefile("./SIG/ReferGCLR.shp")
FranceComC=shapefile("./SIG/Limite_administrative/Communes_L93_centroides.shp")
FranceCom=shapefile("./SIG/Communes_L93.shp")
ReferentSpec=fread("C:/Users/Yves Bas/Downloads/Référents prospections - secteurs_spec.csv",encoding="UTF-8")
...
LRcom=subset(FranceCom,FranceCom$NOM_RégION=="LANGUEDOC-ROUSSILLON")
LRcomC=subset(FranceComC,FranceComC$NOM_RÃ.gIO=="LANGUEDOC-ROUSSILLON")
...
subset(LRcomC$COMMUNE0,LRcomC$Referent=="Blandine CarrÃ© & Yves Bas")
