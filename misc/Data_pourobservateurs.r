...
args="G:/VigieChiro/Raw"
#args="DataRP_SpTronSeuil90.csv"
args[2]="pourHop2019" #suffixe export
SelLoc=F
SelRP=T
SelPF=T
SelSite=F
...
FiltSp="Nyclei"
SelPar=F
ListPar=fread("C:/wamp64/www/ListNaturalia.csv",h=T)
